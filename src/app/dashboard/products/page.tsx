                ...
                <DialogContent className="sm:max-w-[625px]">
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input id="name" placeholder="e.g. Fresh Tomatoes (Grade A)" className="col-span-3" />
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Textarea id="description" placeholder="Product description and specifications" className="col-span-3" />
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
                        ...
                        <div className="grid grid-cols-4 items-center gap-4">
                         ...
                         <div className="grid grid-cols-4 items-center gap-4">
                            ...
                            <Input id="inventory" type="number" placeholder="250" className="col-span-3" />
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
                            <Label htmlFor="bulk-pricing" className="text-right">Bulk Pricing</Label>
                            <Input id="bulk-pricing" placeholder="₹40/kg (50kg+)" className="col-span-3" />
                        </div>
                        <div className="grid grid-cols-4 items-center gap-4">
